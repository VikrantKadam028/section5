const sideNavigation = document.querySelector(".sideNavigation"),
  ...
  inputArea = document.querySelector(".chatWindow .chatContent .inputArea"),
  ...
  styleloc = document.querySelector(".actionList .styleloc");
...
sideBarToggle.addEventListener("click", () => {
  ...
  if (styleloc.style.display === "none") {
    styleloc.style.display = "block";
  } else {
    styleloc.style.display = "none";
  }
